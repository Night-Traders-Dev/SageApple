...
check(contains(os.out, "SAVED MYPROG"), "OS saves the BASIC program")
os.basic.new()
...
os.command("monitor")
check(contains(os.out, "SageApple Monitor"), "OS switches into the monitor")
m.uart_receive("help\r")
os.command("beep")
